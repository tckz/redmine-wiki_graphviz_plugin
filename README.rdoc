...
Source code:
git://github.com/tckz/redmine-wiki_graphviz_plugin.git
...
* graphviz-2.24.0-1.el5
* graphviz-gd-2.24.0-1.el5
* graphviz-ruby-2.24.0-1.el5
* passenger (2.2.5)
* redmine-0.8.6
...
* redmine-0.9.0-stable branch at 2010/01/07(JST)
